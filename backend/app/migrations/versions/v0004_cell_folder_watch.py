...
def upgrade(operations: Operations, connection: Connection) -> None:
    ...
    if not inspector.has_table("cell_folder_watches"):
        operations.create_table(
            ...
            sa.Column("source_format", sa.String(80), nullable=True),
            sa.Column(
                "ordering_rule",
                sa.String(40),
                nullable=False,
            ...
            sa.Column("recursive", sa.Boolean(), nullable=False, server_default=sa.text("0")),
            sa.Column("recursion_depth", sa.Integer(), nullable=False, server_default="0"),
            sa.Column("cadence_value", sa.Integer(), nullable=True),
            sa.Column("cadence_unit", sa.String(20), nullable=True),
