...
- Add Continuous test-time and Cycle-aligned Time/Capacity display modes.
...
- Keep cycle detail visible while scrolling selected points, with a shared series filter and sortable cycle and value columns.

## 0.27.1-alpha.24 - 2026-09-05

### Bug fixes

- Highlight cycle points as they enter or leave an ongoing rectangle or polygon selection.

## 0.27.1-alpha.23 - 2026-09-05

### Bug fixes

- Keep the previous cycle detail figure and axes visible while a new quantity loads, preventing popup size jumps.
- Dismiss cycle inspectors on outside Ctrl clicks while preserving replacement gestures and same-point inspection.
...
- Use accessible dnd-kit sorting for continued-cell source chains.
...
- Improve continued-cell source-chain readability, drag affordance, and date/cycle labels.
...
## 0.26.0-beta.3 - 2026-08-17

- Make protocol group management removable and duplicate-safe.

## 0.26.0-beta.2 - 2026-08-17

- Fix empty-step comparison alignment and grouped DCIR segment display.

## 0.26.0-beta.1 - 2026-08-17

- Add reviewable protocol-family grouping with named source-local protocol options.
...
- Add a read-only protocol-family comparability modal with strict, workflow, and custom comparison modes.

## 0.24.0-beta.2 - 2026-08-17

- Treat capacity-scaled current setpoints as semantic C-rate protocol identity while preserving measured DCIR current.
...
## 0.19.0-beta004 - 2026-08-05

- Collapse the series list with a chevron instead of dragging, keep the preview plot a fixed size across tabs, make legend renaming responsive, and shorten and restyle plot hover labels.
