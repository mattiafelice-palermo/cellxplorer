...
**Status:** In progress — 038.1 R3/R4 follow-ups addressed but review remains changes-required; 038.2 implemented under explicit user direction, review pending
