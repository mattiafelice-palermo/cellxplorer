...
**Authoring baseline / merge base:** `main` at `1542ff3bed7be31b3b0e1f19282c92598dc0fc06` (`0.22.0-beta.1`)  
...
These anchors were rechecked against `main@1542ff3bed7be31b3b0e1f19282c92598dc0fc06`. Every child must still reverify them before editing because the shared branch evolves sequentially.
...
At this baseline the effective bundle is `2026.6.11-cxp3`.
